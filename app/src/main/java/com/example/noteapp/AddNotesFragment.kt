...
class AddNotesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        add_note_bu.setOnClickListener{
            addNotesEvent()
        }
    ...
    fun addNotesEvent() {
        ...
        val descr = ed_note.text.toString()
        ...
        //connect and send values to data base
        val dbManager = DbManager(this!!.activity!!)
        val id=dbManager.insertNote(values)
        if (id>0){
            Toast.makeText(this!!.activity!!,"Record Added",Toast.LENGTH_SHORT).show()
        }else{
            Toast.makeText(this!!.activity!!,"Record failed",Toast.LENGTH_SHORT).show()
        }
